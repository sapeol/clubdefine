...
<div class="container-fluid">
  <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
    <div class="mr-auto">
      ...
      <p class="mb-0">Club Define Admin Dashboard</p>
    </div>
          ...
          <div class="card">
            <div class="card-header d-sm-flex d-block pb-0 border-0">
              <div class="mr-auto pr-3">
                <h4 class="text-black fs-20 mb-0">Customer Percentage</h4>
              </div>
                ...
                <div class="tab-pane fade show active" id="Daily" role="tabpanel">
                  <div class="d-flex flex-wrap align-items-center px-4 bg-light">
                    ...
                    <ul class="users pl-3 py-2">
                      <li><img src="{{ asset('images/users/1.png') }}" alt=""></li>
                      <li><img src="{{ asset('images/users/2.png') }}" alt=""></li>
                      <li><img src="{{ asset('images/users/3.png') }}" alt=""></li>
                      <li><img src="{{ asset('images/users/4.png') }}" alt=""></li>
                      <li><img src="{{ asset('images/users/5.png') }}" alt=""></li>
                    </ul>
                  </div>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <ul class="users-sm mb-3">
                <li><img src="{{ asset('images/users/6.png') }}" alt=""></li>
                <li><img src="{{ asset('images/users/7.png') }}" alt=""></li>
                <li><img src="{{ asset('images/users/8.png') }}" alt=""></li>
                <li><img src="{{ asset('images/users/9.png') }}" alt=""></li>
                <li><img src="{{ asset('images/users/10.png') }}" alt=""></li>
              </ul>
              <div class="d-flex align-items-center">
